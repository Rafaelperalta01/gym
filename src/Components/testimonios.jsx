...
const Testimonios = () => {
    return (
        <section class="text-black dark:text-neutral-300 bg-gray-400">
            ...
            <div class="grid gap-6 text-center md:grid-cols-3 py-10 px-20">
                <div>
                    <div data-aos="flip-left"
                        ...
                        <div class="h-28 overflow-hidden rounded-t-lg bg-orange-600"></div>
                        <div
                ...
                <div>
                    <div data-aos="flip-left"
                        class="block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
                        <div class="h-28 overflow-hidden rounded-t-lg bg-orange-500"></div>
                        <div
                            class="mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800">
                            <img
                                alt="a"
